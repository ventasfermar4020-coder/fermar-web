  ...
  const staffMembers = [
    {
      ...
      description: "Con más de 40 años de experiencia en el sector, Jorge lidera nuestro equipo con pasión y dedicación.",
      image: "/staff/jorge.png",
      email: "jorge@fermar.com"
    },
    {
      id: 2,
      name: "Alonso Alarcon Aguilar",
      position: "Marketing y Programación",
      description: "Alonso se encarga de que todo funcione perfectamente, asegurando la mejor experiencia para nuestros clientes.",
      image: "/staff/alonso1.png",
      email: "alonso@fermar.com"
    },
    {
      id: 3,
      name: "Michell Ana Morales",
      position: "Diseñadora Principal",
      description: "Michell aporta creatividad y estilo único a cada producto que seleccionamos para nuestra tienda.",
      image: "/staff/michell1.png",
      email: "michell@fermar.com"
    },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-[1170px] mx-auto px-6 py-12">
        ...
        <p className="text-[#676767] text-[19px] leading-[36px] mb-16 text-center max-w-3xl mx-auto">
          Somos un equipo apasionado dedicado a ofrecerte los mejores productos y el mejor servicio.
        </p>
        ...
        <div className="mt-16 bg-white rounded-2xl p-12 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <a href="tel:+525620562236" className="text-[#637381] hover:text-[#EC2A2A] transition-colors">
                +52 5620562236
              </a>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <a href="mailto:ventasfernar4020@gmail.com" className="text-[#637381] hover:text-[#EC2A2A] transition-colors">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <a href="https://www.facebook.com/jorge.villanueva.5832343" target="_blank" rel="noopener noreferrer" className="text-[#637381] hover:text-[#EC2A2A] transition-colors">
                @Jorge Villanueva
              </a>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-[#637381]">
                Rio de la Plata Mza.16 Lte. 19. Col Escalerillas. Mpo. Ixtapaluca. Estado de México. C.P.56567
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 bg-gradient-to-br from-[#F9F1E3] to-[#ECE5D8] rounded-2xl p-12">
          ...
          <p className="text-[#637381] text-lg leading-8 max-w-4xl mx-auto text-center">
            Fermar nació de la pasión por los detalles y el deseo de crear experiencias memorables.
            Cada producto que ofrecemos ha sido cuidadosamente seleccionado para asegurar que encuentres
            el regalo perfecto para esa persona especial. Nuestro equipo trabaja incansablemente para
            brindarte una experiencia de compra excepcional y productos de la más alta calidad.
          </p>
        </div>
      </section>
    </div>
